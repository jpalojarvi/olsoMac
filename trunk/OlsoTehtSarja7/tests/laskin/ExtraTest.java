...
public class ExtraTest extends AbstractParent {
	...
	public void testNeliojuuri2() {
		laskin.neliojuuri(2);
		// Tähän tuloksen tarkastus assertXXX(), odotetun tuloksen tulee olla
		// (int)Math.sqrt(2)
		assertEquals(Math.sqrt(2), laskin.annaTulos(), DELTA, "Luvun 2 neliöjuuri väärin");
	}

	@Test
	public void testNelioDouble() {
		laskin.nelio(2.5);
		assertEquals(6.25, laskin.annaTulos(), DELTA, "Luvun 2.5 neliöjuuri väärin");
	}
	...
	public void testNeliojuuriNegat() {
		...
		assertEquals("Negatiivisella luvulla ei ole neliöjuurta", thrown.getMessage());
	}
}